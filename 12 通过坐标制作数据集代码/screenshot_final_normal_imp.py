...
# datPath = 'd:/0-dataset-imp/船dat/'
# imagePath = 'd:/0-dataset-imp/船tif/'
saveAllImagePath = 'd:/3_ship/ship_pic_all/'
saveDefectImagePath = 'd:/3_ship/ship_pic_incomplete/'
saveAllVocXmlPath = 'd:/3_ship/ship_xml_all/'
saveDefectVocXmlPath = 'd:/3_ship/ship_xml_incomplete/'
        ...
        try:
            ...
            while (slide_y1 + bSteps < img.shape[0]):
                ...
                while (slide_x1 + bSteps < img.shape[1]):
                    ...
                    # if max(getBoxNums) > 0.8 and flag_4 == 0:
                    if  flag_4 == 0:
                        ifWrite = 0
                        for numb in range(len(getBoxNums)):
                            if getBoxNums[numb] > 0.35 and getBoxNums[numb] < 0.7:
                                ifWrite = 1
