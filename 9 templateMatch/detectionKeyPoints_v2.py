...
'''1、加载图片'''
img1 = cv2.imread('/home/huangfu/桌面/face/beauty.jpg',cv2.IMREAD_GRAYSCALE)
#img1 = cv2.resize(img1,dsize=(400,800))
img2 = cv2.imread('/home/huangfu/桌面/face/webwxgetmsgimg121.png',cv2.IMREAD_GRAYSCALE)
...
'''2、提取特征点'''
#创建一个SURF对象
surf = cv2.xfeatures2d.SURF_create(4500)
